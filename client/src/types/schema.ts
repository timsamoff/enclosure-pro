...
export const ENCLOSURE_TYPES = {
  "1590A": { width: 38.5, height: 93.6, depth: 28, rotatesLabels: true, cornerStyle: "rounded" as const, rotatesLabels: true  },
  "1590B": { width: 60.9, height: 111.9, depth: 29, rotatesLabels: true, cornerStyle: "rounded" as const, rotatesLabels: true  },
  "1590LB": { width: 50.5, height: 50.5, depth: 29, rotatesLabels: false, cornerStyle: "rounded" as const, rotatesLabels: true  },
  "125B": { width: 66, height: 121, depth: 35.94, rotatesLabels: true, cornerStyle: "rounded" as const, rotatesLabels: true  },
